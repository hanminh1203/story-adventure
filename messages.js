...
// This file intentionally contains only user-facing strings so they can be
...
const UI_TEXT = {
  ...
  TUTORIAL_STEP_3:
    "Can you find the hidden {treasures}? Tap them for treasure!",
  TUTORIAL_SPEAKER_TEMPLATE: "{name} says:",
  TUTORIAL_SPEAKER_FALLBACK: "Your guide says:",

  // Achievements & final screen
  ACHIEVEMENT_ALL_ITEMS_AT_LOCATION:
    "All {itemsName} found at {locationName}!",
  ...
  FINAL_CHARACTER_PROUD_TEMPLATE:
    "{characterName} is proud of your adventure!",
  ...
  // Start / character select / final screens
